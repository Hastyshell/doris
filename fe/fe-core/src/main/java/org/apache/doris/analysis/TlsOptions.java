 ...
 * </ul>
 */
public class TlsOptions implements Writable {

    @SerializedName("hasRequireClause")
    private boolean hasRequireClause;

    @SerializedName("requireNone")
    ...
    public static TlsOptions read(DataInput in) throws IOException {
        String json = Text.readString(in);
        TlsOptions options = GsonUtils.GSON.fromJson(json, TlsOptions.class);
        return options == null ? notSpecified() : options;
    }
